...
//        File students = new File("\\Git\\Java_Introduction\\src\\Java_Seminar2_HW\\Task1_Students.txt");
...
//            input = scan.nextLine();  // Если будет больше одной строки, то потребуется +=.
...
/*
        try (FileWriter fw = new FileWriter("Task1_Students.txt", false)) {
            fw.write(res);
        ...
        File students = new File("E:\\Git\\Java_Introduction\\src\\Java_Seminar2_HW\\Task1_Students.txt");
        FileReader reader = new FileReader("E:\\Git\\Java_Introduction\\src\\Java_Seminar2_HW\\Task1_Students.txt");
